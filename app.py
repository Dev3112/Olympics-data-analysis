...
region_df = pd.read_csv('noc_regions.csv', sep=',')

df = preprocesser.preprocess(df, region_df)

st.sidebar.title('Olympics Analysis')
st.sidebar.image('oly_1.png')
...
if user_menu == 'Athlete-wise Analysis':
    ...
    x = []
    name = []
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming', 'Badminton', 'Sailing', 'Gymnastics', 'Weightlifting', 'Wrestling', 'Water Polo', 'Hockey', 'Rowing', 'Fencing', 'Archery', 'Shooting', 'Boxing', 'Taekwondo', 'Cycling', 'Diving', 'Canoeing', 'Golf', 'Table Tennis', 'Diving', 'Ice Hockey', 'Beach Volleyball', 'Triathlon', 'Rugby', 'Polo', 'Handball', 'Rugby Sevens']
